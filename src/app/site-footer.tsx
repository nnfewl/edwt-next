...
import { faArrowUpRightFromSquare, faStethoscope } from "@fortawesome/free-solid-svg-icons";

/**
 * Shared site footer (brand, data source, status page, disclaimer). Styled in
 * globals.css with self-contained tokens — like .app-topbar — so it renders
 * identically on every page that mounts it.
 */
      ...
      <div className="footer-bar">
        <div className="footer-brand">
          <span className="footer-mark" aria-hidden="true">
            <FontAwesomeIcon icon={faStethoscope} width={16} height={16} aria-hidden="true" />
          </span>
        ...
        <div className="footer-meta">
          ...
          >
            ...
            <FontAwesomeIcon icon={faArrowUpRightFromSquare} width={11} height={11} aria-hidden="true" />
          </a>
          <a
