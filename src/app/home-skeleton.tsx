...
function SkeletonStat() {
  return (
    <div className="stat home-skeleton-fade">
      <div className="stat-label"><Bar width="86px" height="12px" /></div>
      <div style={{ marginTop: 8 }}><Bar width="110px" height="30px" /></div>
      <div style={{ marginTop: 10 }}><Bar width="150px" height="12px" /></div>
    </div>
  );
}
    ...
    <article className="facility home-skeleton-fade" aria-hidden="true">
      <div className="left">
        <div className="badges">
          <Bar width="92px" height="22px" />
          <Bar width="110px" height="22px" />
          <Bar width="76px" height="22px" />
        </div>
        <div style={{ marginTop: 12 }}><Bar width="min(320px, 70%)" height="22px" /></div>
        <div style={{ marginTop: 10 }}><Bar width="min(420px, 88%)" height="14px" /></div>
        <div className="actions" style={{ marginTop: 14 }}>
          <Bar width="118px" height="34px" />
          <Bar width="92px" height="34px" />
        </div>
      </div>
      <div className="home-skeleton-wait">
        <Bar width="96px" height="52px" />
        <div style={{ marginTop: 10 }}><Bar width="120px" height="12px" /></div>
      </div>
    </article>
  );
}
