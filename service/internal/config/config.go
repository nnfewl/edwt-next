...
type Config struct {
	...
	ArchiveFailThreshold int           // consecutive failed archive writes before archive is flagged unhealthy
...
func Load() (Config, error) {
	c := Config{
		...
		ArchiveFailThreshold: envInt("EDWT_ARCHIVE_FAIL_THRESHOLD", 3),
